...
export default function Cta() {
    return (
        <div className="relative isolate overflow-hidden bg-gray-900">
            <div className="absolute inset-0 flex items-center justify-center -z-10 top-0">

                <Image
                    src="/ai-generator-15.png"
                    width={400}
                    height={300}
                    alt=""
            ...
            <div className="mx-auto max-w-7xl px-6 pb-24 ml-96 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
                <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-sm lg:pt-8">
